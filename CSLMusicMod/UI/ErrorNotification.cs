...
namespace CSLMusicMod.UI
{
    public class ErrorNotification : ListNotification
    {
        ...
        /// <summary>
        /// The Steam Workshop ID for the "Support" button.
        /// </summary>
        public ulong WorkshopId { get; set; } = 3567203713;
        /// <summary>
        ...
        internal static void ShowNotification(string message) => ShowNotification(CSLMusicMod.Instance.Name, 3567203713, message);
    }
}
